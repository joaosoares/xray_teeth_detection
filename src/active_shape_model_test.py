    ...
    def test_from_shapes(self):
        shapes = [
            Shape([(1, 2), (1, 3), (1, 4), (2, 4), (3, 4), (3, 3), (3, 2),
                   (2, 2)]),
            Shape([(5, 2), (6, 3), (7, 4), (8, 3), (9, 2), (8, 1), (7, 0),
                   (6, 1)]),
            Shape([(5, 2), (6, 3), (8, 4), (8, 3), (9, 2), (8, 1), (7, 0),
                   (6, 1)]),
            Shape([(5, 2), (6, 3), (6, 4), (8, 3), (9, 2), (8, 1), (7, 0),
                   (6, 1)]),
            Shape([(5, 2), (6, 2), (8, 4), (8, 3), (9, 2), (8, 1), (7, 0),
                   (6, 1)]),
            Shape([(5, 2), (6, 4), (8, 4), (8, 3), (9, 2), (8, 1), (7, 0),
                   (6, 1)])
        ]
        ...
        data = standard_pca.fit(
            np.array([shape.as_vector() for shape in shapes]))
